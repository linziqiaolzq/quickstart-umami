<h1> Rapid deployment of the Umami on Alibaba Cloud compute nest </h1>
...
<p>Umami is an open-source website analytics tool that is lighter compared to Google Analytics and does not collect personal information from website users. Additionally, Umami features a clean dashboard with an elegant UI, making it easy for us to view historical website data.</p>
<p>
    GitHub address of this project: <a href='https://github.com/umami-software/umami'>https://github.com/umami-software/umami</a></p>

<h2> Prerequisites </h2>

<p><font style="color:rgb(51, 51, 51);"> To deploy a Umami community edition service instance, you need to
...
<p><font style="color:rgb(51, 51, 51);"> The cost of Umami community edition deployment in computing nest
...
<p> This service requires ECS instance can access Umami server from public network. </p>
...
<ol>
    <li> visit the compute nest Umami<a
            href="https://computenest.console.aliyun.com/service/instance/create/default?type=user&ServiceName=Umami社区版">
    ...
    <li> Access the Umami dashboard (default username: admin, default password: umami)</li> <img src="./7.jpg" alt=""/><img src="./8.jpg" alt=""/>
</ol>